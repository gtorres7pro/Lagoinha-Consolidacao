...
target = """                    card.className = 'person-card';
                    card.innerHTML = `
                        ...
                        <div class="tags-area">
                            <span class="tag decision">🔥 Decisão: ${cap(lead.decisao)}</span>
                            <span class="tag service">🏛 Culto: ${cap(lead.culto)}</span>
                            ...
                            <span class="tag gc">👥 GC: ${cap(lead.gc_status)}</span>
                        </div>
...
replacement = """                    card.className = 'person-card';
