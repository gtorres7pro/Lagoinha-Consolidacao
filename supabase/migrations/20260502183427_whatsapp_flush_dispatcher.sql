-- Dispatch WhatsApp IA flushes through a tiny Edge Function that responds
-- immediately to pg_net and runs the slower LLM/send flow in the background.
...
begin
  ...
  select net.http_post(
    url := 'https://uyseheucqikgcorrygzc.supabase.co/functions/v1/whatsapp-flush-dispatch',
  ...
  values ('pg_net_flush_dispatcher_queued', new.lead_id::text, new.id::text, request_id, payload::text);
